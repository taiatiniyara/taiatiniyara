  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-1">Blog Posts</h2>
          <p className="text-sm sm:text-base text-muted-foreground">Manage your blog content</p>
        </div>
        <Button 
          onClick={() => {
      ...
      <div className="space-y-4">
        {data?.map((post) => (
          <div key={post.id} className="bg-card border rounded-lg p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
