        ...
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
          <Card className="overflow-hidden shadow-xl">
            ...
            <div className="p-4 sm:p-6 md:p-8">
              ...
              {/* Description Section */}
              <div className="mb-6">
                <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Description</h2>
              ...
              {project.technologies && project.technologies.length > 0 && (
                <>
                  <Separator className="my-6" />
                  <div className="mb-6">
                    <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Technologies Used</h2>
                    <div className="flex flex-wrap gap-2">
              ...
              {(project.repo_url || project.live_url) && (
                <>
                  <Separator className="my-6" />
                  <div className="mb-6">
                    <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Project Links</h2>
