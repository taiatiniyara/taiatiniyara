      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {courses?.map((course) => (
            <div
              key={course.id}
              className="bg-card border rounded-lg p-4 sm:p-6 shadow-md hover:shadow-xl transition-all hover:scale-[1.02] animate-in fade-in slide-in-from-bottom-4 duration-700"
            >
              ...
              <h2 className="text-xl sm:text-2xl font-bold mb-3">{course.title}</h2>
