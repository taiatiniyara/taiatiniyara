          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="p-6 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold mb-2">Blog & Resources</h3>
                  <p className="text-muted-foreground mb-4">Read articles and tutorials</p>
            ...
            <Card className="p-6 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-4">Explore portfolio and case studies</p>
                  <a href="/projects" className="text-primary font-medium hover:underline flex items-center gap-1 group">
                    View Projects
                    <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
