      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <Card className="p-4 sm:p-6 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">View and manage your enrolled courses</p>
            ...
            <Card className="p-4 sm:p-6 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-chart-2/10 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-chart-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-lg sm:text-xl font-bold mb-2">My Profile</h3>
                  <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">Manage your account settings</p>
          ...
          <Card className="p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">Your recent activity will appear here.</p>
          </Card>
        </div>
      </div>
    </div>
