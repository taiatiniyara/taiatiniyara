...
function BlogIndex() {
  ...
  const { data: postsData, isLoading: postsLoading, error: postsError } = selectedTag
  ...
  const error = postsError ? (postsError instanceof Error ? postsError.message : 'Failed to load posts') : null;
