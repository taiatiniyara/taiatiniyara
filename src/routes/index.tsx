      ...
      <div className="min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p
              className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-400 mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed px-4 animate-fade-in"
              style={{ animationDelay: "0.1s" }}
            >
              Full-Stack Software Developer crafting elegant solutions through
              clean code, innovative design, and scalable architecture
            </p>

            {/* Navigation Cards */}
            <div
              className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto px-4 animate-fade-in"
